      ...
      <div className="navbar bg-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6">
            <a className="btn btn-ghost normal-case text-base" href="#features">Fitur</a>
            <a className="btn btn-ghost normal-case text-base" href="#about">Tentang</a>
            <a className="btn btn-ghost normal-case text-base" href="#contact">Kontak</a>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white shadow-md w-full absolute top-16 left-0 z-40">
            <div className="flex flex-col items-center gap-4 py-4">
              <a href="#features" className="btn btn-ghost">Fitur</a>
              <a href="#about" className="btn btn-ghost">Tentang</a>
        ...
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 px-4">
          <div className="card bg-white shadow-xl p-6">
            <div className="card-body items-center text-center">
              ...
              <h3 className="card-title text-lg">Monitoring Real-Time</h3>
          ...
          <div className="card bg-white shadow-xl p-6">
            <div className="card-body items-center text-center">
              ...
              <h3 className="card-title text-lg">Sensor Lengkap</h3>
              <p className="text-gray-600 text-sm">Suhu, kelembaban, CO2, pH, hingga kelembaban tanah terkoneksi otomatis.</p>
            </div>
          </div>
          <div className="card bg-white shadow-xl p-6">
            <div className="card-body items-center text-center">
              <Cloud size={48} className="text-green-600 mb-4" />
              <h3 className="card-title text-lg">Kontrol Otomatis</h3>
        ...
        <div className="container mx-auto text-center px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="font-semibold text-lg mt-4">Ramah Lingkungan</h4>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="font-semibold text-lg mt-4">Produktivitas Maksimal</h4>
